...
public class Registration {
    ...
    public static final DeferredItem<ItemRainbowCoal> RAINBOW_COAL = ITEMS.registerItem("rainbow_coal", ItemRainbowCoal::new, () -> new Item.Properties().stacksTo(1).component(DataComponents.COOKING_FUEL, new CookingFuel(new ResolvableInt.Constant(200), ResolvableFloat.fromKey(ContextFloatProviders.COOKING_DEFAULT_SPEED_MULTIPLIER))));

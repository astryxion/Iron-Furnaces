...
/* 15 */     super((MenuType)Registration.ALLTHEMODIUM_FURNACE_CONTAINER.get(), windowId, world, pos, playerInventory, player);
/* 16 */     this.te = (BlockIronFurnaceTileBase)world.getBlockEntity(pos);
/*    */   }
/*    */ }


/* Location:              C:\Users\tinop\curseforge\minecraft\Instances\wdeqw\mods\ironfurnaces-1.20.1-4.1.8.jar!\ironfurnaces\container\furnaces\other\BlockAllthemodiumFurnaceContainer.class

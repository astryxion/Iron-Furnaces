...
public class RecipeCategoryGeneratorBlasting implements IRecipeCategory<GeneratorRecipe> {
    ...
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(IronFurnaces.MOD_ID, "category_generator_blasting");
    ...
    public RecipeCategoryGeneratorBlasting(IGuiHelper guiHelper)
    {
        ...
        staticFlame = guiHelper.createDrawable(ResourceLocation.fromNamespaceAndPath(IronFurnaces.MOD_ID, "textures/gui/jei.png"), 68, 0, 14, 14);
        animatedFlame = guiHelper.createAnimatedDrawable(staticFlame, 300, IDrawableAnimated.StartDirection.TOP, true);

        staticEnergy = guiHelper.createDrawable(ResourceLocation.fromNamespaceAndPath(IronFurnaces.MOD_ID, "textures/gui/jei.png"), 82, 0, 14, 42);
    ...
    public IDrawable getBackground() {
        return guiHelper.createDrawable(ResourceLocation.fromNamespaceAndPath(IronFurnaces.MOD_ID, "textures/gui/jei.png"), 0, 0, 68, 42);
    }
